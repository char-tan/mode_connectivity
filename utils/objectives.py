...
def heuristic_triplets(all_models, loss_metric, data_iterator, device, learning_rate, n):
    """Objective Function """
    i = randint(1, n)
...
def full_params(all_models, loss_metric, data_iterator, device, learning_rate, n):
    """Objective function """
    ...
    loss = metric_path_length(all_models, loss_metric, batch_images)
